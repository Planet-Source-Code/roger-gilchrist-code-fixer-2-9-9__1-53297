...
Public Function ExtractName(ByVal strCode As String) As String
  ...
  For I = LBound(arrTmp) To UBound(arrTmp)
    ...
    If Not ArrayMember(arrTmp(I), "Private", "Public", "Friend", "Type", "Static", "Enum", "Declare", "Let", "Set", "Get", "Sub", "Function", "Property", "Event", "WithEvents", "Const") Then
...
Private Function ExtractVariableType(ByVal strCodeOnly As String, _
  ...
  For I = LBound(arrTmp) To UBound(arrTmp)
    If Not ArrayMember(arrTmp(I), "Private", "Public", "Friend", "Static", "Let", "Set", "Get") Then
...
Private Function GenerateUsageMsg(ByVal strHomeMod As String, _
                                  ...
                                  ByVal bMultiForm As Boolean) As String
  ...
  If Len(strInput) Then
    ...
    If StrScope = "Public" Then
     ...
     Else
      If UBound(ArrProc) > 0 Then
       ...
       Else
        If ArrayMember(strComType, "Declare", "Function", "Sub", "Property", "Const") Or ((TotalCount = 1) And InStr(strLocations, "(Declarations)")) Then
          strSuggestDim = ""
         Else
          If bIsReset Then
   ...
   Else
    ...
    End If
  End If
  Do While MultiRight(GenerateUsageMsg, True, UsageSign & vbTab)
...
SkipComp:
      ...
      Next Comp
    Next Proj
    GetDeclarationCount = GenerateUsageMsg(strHomeMod, strComType, strWord, strTmp, strProc, bNoRefInHomeMod, ModCount, TotalCount, "Declaration", StrScope, IsReset, bIsFormModuleInterface, bMultiForm)
  End If
  On Error GoTo 0
...
SkipComp:
    ...
    Next Comp
  Next Proj
  GetProcedureCount = GenerateUsageMsg(strHomeMod, strComType, strWord, strTmp, strProc, True, ModCount, TotalCount, "Procedure", StrScope, False, True, bMultiForm)
  On Error GoTo 0
    ...
    If StrScope = "Private" Then
     ...
     Else
      If LenB(strHomeMod) Then
        If MultiLeft(ArrProc(I), True, strHomeMod) Then  'add brackets to indicate home module
          ArrProc(I) = "<" & ArrProc(I)
...
':)Code Fixer V2.9.6 (9/02/2005 3:08:28 AM) 1 + 746 = 747 Lines Thanks Ulli for inspiration and lots of code.
