    ...
    For K = 1 To .Properties.Count
      ...
      Select Case strPropName
       ...
       Case "Picture", "Icon", "DragIcon", "MouseIcon", "DisabledPicture", "DownPicture", "Palette"
        If IsNumeric(strValue) Or ArrayMember(strValue, "True", "False") Then
         ...
         Else
          Select Case strType
           ...
           Case "String", "Boolean", "Long", "Single", "Integer"
            If isReadWriteProperty(.ClassName, strPropName) And Not ArrayMember(strPropName, "Columns", "MultiSelect", "LinkMode", "WhatsThisHelp", "StartUpPosition", "Name", "Moveable") Then
  ...
  For K = 1 To Comp.Properties.Count
    ...
    Select Case strPropName
     ...
     Case "Picture", "Icon", "MouseIcon"
      ...
      End If
     Case Else
      If isReadWriteProperty(ModuleType(Comp.CodeModule), strPropName) And Not ArrayMember(strPropName, "LinkMode", "WhatsThisHelp", "StartUpPosition", "Name", "Moveable") Then
        strTmp = strTmp & StrIndt & "." & strPropName & " = " & strValue
       Else
...
':)Code Fixer V2.9.6 (9/02/2005 3:12:11 AM) 1 + 440 = 441 Lines Thanks Ulli for inspiration and lots of code.
