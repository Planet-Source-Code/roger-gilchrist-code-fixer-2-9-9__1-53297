  ...
  With cMod
    ...
    If .CountOfDeclarationLines = 0 Then
      ...
      .InsertLines 1, IIf(Xcheck(XVerbose), OptExplicitMsgVerbose, OptExplicitMsg) & vbNewLine & _
       "Option Explicit"
    End If
    If Not FindCodeUsage("Option Explicit", "", .Parent.Name, True, True, False) Then
      .InsertLines 1, IIf(Xcheck(XVerbose), OptExplicitMsgVerbose, OptExplicitMsg) & vbNewLine & _
       "Option Explicit"
    End If
...
':)Code Fixer V2.9.6 (9/02/2005 3:01:17 AM) 11 + 201 = 212 Lines Thanks Ulli for inspiration and lots of code.
