...
Public Sub GenerateReferencesEnumArray()
    ...
    For I = 1 To INTERFACE.Count
      If Right$(INTERFACE.Item(I).Name, Len(strCtrlClass)) = strCtrlClass Then
        For J = 1 To INTERFACE.Item(I).Members.Count
          If ArrayMember(INTERFACE.Item(I).Members.Item(J).InvokeKind, tli.INVOKE_PROPERTYGET, tli.INVOKE_PROPERTYPUT) Then
...
Public Function ReferenceLibraryControlProperty(ByVal strTest As String, _
  ...
  If LenB(strLib) Then
    ...
    For I = 1 To INTERFACE.Count
      If Right$(INTERFACE.Item(I).Name, Len(strCtrlClass)) = strCtrlClass Then
        For J = 1 To INTERFACE.Item(I).Members.Count
          If ArrayMember(INTERFACE.Item(I).Members.Item(J).InvokeKind, tli.INVOKE_PROPERTYGET, tli.INVOKE_PROPERTYPUT, tli.INVOKE_PROPERTYPUTREF) Then
...
':)Code Fixer V2.9.6 (9/02/2005 2:55:31 AM) 6 + 1220 = 1226 Lines Thanks Ulli for inspiration and lots of code.
