   ...
   Begin VB.Frame fraprop 
      ...
      Begin VB.PictureBox picCFXPBugFixSettings 
         ...
         Begin VB.Frame fraSubSetting 
            ...
            Top             =   0
            Width           =   6375
            Begin prj_CodeFix2.PropertyList PropertyList1 
               Height          =   2160
               Index           =   0
               Left            =   120
               TabIndex        =   114
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":0442
         ...
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":046E
               formatstring    =   "Property|Value"
            End
         End
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":049A
               formatstring    =   "Property|Value"
            End
         End
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":04C6
               formatstring    =   "Property|Value"
            End
         End
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":04F2
               formatstring    =   "Property|Value"
            End
         End
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":051E
               formatstring    =   "Property|Value"
            End
         End
         Begin VB.Frame fraSubSetting 
            ...
            Begin prj_CodeFix2.PropertyList PropertyList1 
               ...
               rows            =   6
               fixedrows       =   1
               font            =   "frm_FindSettings.frx":054A
               formatstring    =   "Property|Value"
            End
         End
...
Private Function ChkReplace2Bool(intIndex As Integer) As Boolean
...
Private Function ChkShow2Bool(intIndex As Integer) As Boolean
...
Private Sub PropertyList1_Change(Index As Integer)

  Dim arrTmp As Variant

  If Len(UserSettings) Then
    arrTmp = Split(UserSettings, "|")
    arrTmp(Index) = PropertyList1(Index).DataString
...
Private Sub RestoreOriginals()
  ...
  If Not bAddinTerminate Then
    ...
    OptElseIndent(OrigCaseIndent).Value = True
...
':)Code Fixer V2.9.6 (9/02/2005 2:54:40 AM) 32 + 499 = 531 Lines Thanks Ulli for inspiration and lots of code.
