...
Begin {AC0714F6-3D04-11D1-AE7D-00A0C90F26F4} Dsr_Connect 
   ...
   _ExtentY        =   17119
   _Version        =   393216
   Description     =   "Dockable Find tool with Code Fixer"
   DisplayName     =   "Code Fixer 2"
...
'Public WithEvents ce                                As CommandBarEvents
...
Private Sub AddinInstance_OnConnection(ByVal Application As Object, _
  ...
  '      .SetData frm_Help.picHelp.Image
  ...
  Set mWindow = VBInstance.Windows.CreateToolWindow(AddInInst, "prj_CodeFix2.FindDoc", AppDetails, mstrGuid, mObjDoc)
...
Private Sub CtrlHandler_ItemRenamed(ByVal VBControl As VBIDE.VBControl, _
...
':)Code Fixer V2.9.6 (9/02/2005 2:55:03 AM) 49 + 398 = 447 Lines Thanks Ulli for inspiration and lots of code.
