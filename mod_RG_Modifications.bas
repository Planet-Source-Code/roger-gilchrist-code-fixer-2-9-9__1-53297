...
Public Function DuplicateEnumCapitalizationTest(cMod As CodeModule, _
  ...
  With cMod
    ...
    If L_Startline > 2 Then
      ...
      If MultiLeft(strPrev, True, Hash_If_False_Then) Then
        If MultiLeft(strNext, True, Hash_End_If) Then
...
Public Function ReservedWordAs_Type_or_Enum_Member(ByVal strSearch As String) As Boolean
  ...
  If InstrAtPositionArray(strSearch, IpMiddle, True, "As", vbTab & "As") Then
    If InstrAtPositionArray(LCase$(strSearch), IpLeft, True, "type") Then
...
':)Code Fixer V2.9.6 (9/02/2005 3:04:15 AM) 58 + 1285 = 1343 Lines Thanks Ulli for inspiration and lots of code.
