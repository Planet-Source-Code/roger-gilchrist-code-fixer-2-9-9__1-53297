...
Public Sub DoFind(Flsv As ListView)
  ...
  GotIt = GetFoundCodeLine(StrProjName, strCompName, strFound, Comp, StartLine)
        ...
        For Each Comp In Proj.VBComponents
          If LenB(Comp.Name) Then
            If Comp.Name = strCompName Then
              ...
              StartLine = 1
              'Do While GetWholeCaseMatchCodeLine(Proj.Name, Comp.Name, strFound, strDummy, StartLine)
              Do While GetWholeCaseMatchCodeLine(Proj.Name, Comp.Name, strFound, "", StartLine)
...
Public Sub FindInCode(strFind As String, _
                      strCmp As String, _
                      strPrj As String)
  ...
  'Do While GetWholeCaseMatchCodeLine(strPrj, strCmp, strFind, strDummy, StartLine)
...
Public Function GetFoundCodeLine(VarProjName As Variant, _
                                 ...
                                 Optional lngStartLine As Long) As Boolean
  ...
  If Not vComp Is Nothing Then
    GetFoundCodeLine = vComp.CodeModule.Find(varFind, lngStartLine, 1, -1, -1, False, False, False)
  End If
...
Public Sub InsertInCode(strFind As String, _
...
':)Code Fixer V2.9.6 (9/02/2005 3:10:19 AM) 88 + 1384 = 1472 Lines Thanks Ulli for inspiration and lots of code.
