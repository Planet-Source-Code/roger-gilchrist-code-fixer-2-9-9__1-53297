...
Public Property Let DataString(ByVal DataStr As String)
  ...
  For I = 1 To Len(DataStr)
    ...
    If Mid$(cGrid.TextMatrix(I, eOptLimits), ValPos, 1) <> "0" Then
      ...
      '     Else
      'Dim J      As Long
      '      If ValPos > DataValue(I) Then
      '        For J = DataValue(I) + 1 To UBound(arrtmp)
      '          If Mid$(cGrid.TextMatrix(I, eOptLimits), J, 1) <> "0" Then
      '            cGrid.TextMatrix(I, eValue) = " " & arrtmp(J - 1)
      '          End If
      '        Next J
      '       Else
      '        For J = ValPos To LBound(arrtmp) + 1 Step -1
      '          If Mid$(cGrid.TextMatrix(I, eOptLimits), J, 1) <> "0" Then
      '            cGrid.TextMatrix(I, eValue) = " " & arrtmp(J - 1)
      '          End If
      '        Next J
...
':)Code Fixer V2.9.6 (9/02/2005 3:12:50 AM) 90 + 836 = 926 Lines Thanks Ulli for inspiration and lots of code.
