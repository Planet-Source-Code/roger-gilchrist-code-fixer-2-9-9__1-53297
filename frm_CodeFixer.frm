...
Private Sub tbsModule_Click()
  ...
  With tbsModule
    ...
    fraModule(.SelectedItem.Index).Caption = ""
...
Private Sub txtModuleEdit_Change(Index As Integer)
  ...
  cmdEditMod(2).Enabled = Not MultiLeft(txtModuleEdit(1).Text, True, txtModuleEdit(0).Text & ".") And Selected > -1 And Not ROnly
...
Private Sub txtProjectEdit_Change(Index As Integer)
  ...
  cmdEditProj(2).Enabled = Not MultiLeft(txtProjectEdit(1).Text, True, txtProjectEdit(0).Text & ".")
...
':)Code Fixer V2.9.6 (9/02/2005 2:55:12 AM) 10 + 1042 = 1052 Lines Thanks Ulli for inspiration and lots of code.
