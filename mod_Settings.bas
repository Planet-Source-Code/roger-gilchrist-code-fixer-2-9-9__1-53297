...
Public Const DefNoSettings       As String = "033300201101200000|000000000000000000000000000|0000000|00000000000|0000000000000|0000000000000|030000"
Public Const DefMinSettings      As String = "133310211111211213|333332111111111111111011111|1111111|11112111133|1111111111111|1111111111110|133333"
Public Const DefAvgSettings      As String = "133310222222222213|333332122222222222222222222|2221222|22222222233|1111111111111|1122222222220|233333"
Public Const DefMaxSettings      As String = "133310333333333313|333332223333333222222222222|2221222|33333323333|1111111111111|1122222222222|333333"
...
Private NSortModules, RemoveLineNum, UpDateStrConcat, UpdateChrToConstant, UpdateStrFunction
...
Private FormatRoutineLineContinuation, DummyFixEnd
#End If
...
Private Sub GetFixSetting2(ByVal LsvNo As Long, _
  ...
  FixData(FixNo).FixLevel = Val(Mid$(frm_FindSettings.PropertyList1(LsvNo).DataString, ListRow, 1))
...
Private Sub InitalisePropertyList(ByVal UCNo As Long)
  ...
  With frm_FindSettings.PropertyList1(UCNo)
    .Clear
...
Private Sub RefreshUserSettings()
  ...
  For I = 0 To DummyFixEnd - 1
    ...
    If ArrayMember(I, LayOutAtTypeEOLComment, SecondryExitFix, ConvertFunction2Sub, CodeTypeSuffixStrip, VeryBigProc_CXX, CommentOutClassmembers, FormatRoutineLineContinuation) Then
...
Public Sub SettingCollector()
  ...
  With frm_CodeFixer
    ...
    'ReStructure Section Fixers
    GetFixSetting2 1, 1, NSortModules
    GetFixSetting2 1, 2, RemoveLineNum
    GetFixSetting2 1, 3, UpDateStrConcat
    GetFixSetting2 1, 4, UpdateChrToConstant
    GetFixSetting2 1, 5, UpdateStrFunction
    GetFixSetting2 1, 6, UpdateErrError
    GetFixSetting2 1, 7, UpdateInteger2Long
    GetFixSetting2 1, 8, UnNeededExit
    GetFixSetting2 1, 9, NIfThenExpand
    GetFixSetting2 1, 10, SeperateCompounds
    GetFixSetting2 1, 11, UpdateWend
    GetFixSetting2 1, 12, NPleonasmFix
    GetFixSetting2 1, 13, NCloseResumeLoad
    GetFixSetting2 1, 14, NCloseResume
    GetFixSetting2 1, 15, WithPurity
    GetFixSetting2 1, 16, DetectShortCircuit
    GetFixSetting2 1, 17, DetectZeroLengthStringTests
    GetFixSetting2 1, 18, DetectZeroLengthStringAssign
    GetFixSetting2 1, 19, DetectWithStructure
    GetFixSetting2 1, 20, RoutineCaseFix
    GetFixSetting2 1, 21, PublicVar2Property
    GetFixSetting2 1, 22, UnNeededIfBracket
    GetFixSetting2 1, 23, UnNeededAmpersand
    GetFixSetting2 1, 24, UnNeededCall
    GetFixSetting2 1, 25, UneededCaseIs
    GetFixSetting2 1, 26, CollapseIfThenBool
    GetFixSetting2 1, 27, CollapseCaseBool
    GetFixSetting2 1, 28, SecondryExitFix
...
Private Sub SettingFrameFormat2(ByVal LsvNo As Long)
  ...
  With frm_FindSettings.PropertyList1(LsvNo)
    .Top = offset / 2
    .Left = offset
...
Public Sub SetUpSettingFrame()
  ...
  With frm_FindSettings.PropertyList1(0)
    ...
    .AddProperty "111X", "Move API calls to bottom of Declarations", "Layout style issue"
    ...
    .DrawPropertyBox
  End With
  With frm_FindSettings.PropertyList1(1)
    ...
    .AddProperty "1X10", "Update Integer to Long", "In 32-bit systems Long is more efficent than Integer. However some API Types contain required Integer members."
    ...
    .DrawPropertyBox
  End With
  With frm_FindSettings.PropertyList1(2)
    ...
    .DrawPropertyBox
  End With
  With frm_FindSettings.PropertyList1(3)
  ...
  End With
  '
  With frm_FindSettings.PropertyList1(4)
  ...
  End With
  '
  With frm_FindSettings.PropertyList1(5)
  ...
  End With
  '
  With frm_FindSettings.PropertyList1(6)
...
Public Sub UserSet2(ByVal LsvNo As Long, _
  ...
  Next I
  If Len(frm_FindSettings.PropertyList1(LsvNo).DataString) Then
    frm_FindSettings.PropertyList1(LsvNo).DataString = StrSetting
  End If

End Sub

':)Code Fixer V2.9.6 (9/02/2005 3:04:54 AM) 157 + 496 = 653 Lines Thanks Ulli for inspiration and lots of code.
