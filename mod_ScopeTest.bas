            ...
            If GetWholeCaseMatchCodeLine(Proj.Name, Comp.Name, strFind, strCode, StartLine) Then
              Do
                ...
                If StartLine >= CompMod.CountOfLines Then
                  Exit Do
                End If
              Loop While GetWholeCaseMatchCodeLine(Proj.Name, Comp.Name, strFind, strCode, StartLine)
            End If
          End If
...
':)Code Fixer V2.9.6 (9/02/2005 3:04:47 AM) 9 + 111 = 120 Lines Thanks Ulli for inspiration and lots of code.
