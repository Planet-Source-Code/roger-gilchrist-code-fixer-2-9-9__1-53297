...
Private Const XPLookXML           As String = "<?xml version=""1.0"" encoding=""UTF-8"" standalone=""yes""?>" _
& vbCrLf & "<assembly xmlns=""urn:schemas-microsoft-com:asm.v1"" manifestVersion=""1.0"">" & vbCrLf _
& "<assemblyIdentity version=""1.0.0.0"" processorArchitecture=""X86"" name=""$"" type=""win32"" />" _
& vbCrLf & "<description>XP-Look - Created by Code Fixer</description>" & vbCrLf & "<dependency>" & _
vbCrLf & "<dependentAssembly>" & vbCrLf & "<assemblyIdentity type=""win32"" name=""Microsoft.Windows.Common-Controls"" version=""6.0.0.0"" processorArchitecture=""X86"" publicKeyToken=""6595b64144ccf1df"" language=""*"" />" _
& vbCrLf & "</dependentAssembly>" & vbCrLf & "</dependency>" & vbCrLf & "</assembly>"
...
':)Code Fixer V2.9.6 (9/02/2005 3:08:52 AM) 17 + 311 = 328 Lines Thanks Ulli for inspiration and lots of code.
